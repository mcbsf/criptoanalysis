...
def cleaner_builder(document, lower_words=True, fold_numbers=False, remove_stopwords=False, do_stemming=True, do_lemmatizing=False):
    
    tagged_words = _extract_tagged_words(document)
    if (lower_words):
